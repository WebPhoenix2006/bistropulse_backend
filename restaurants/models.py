...
class Restaurant(models.Model):
    ...
    owner_nid = models.FileField(upload_to='nid/', null=True, blank=True)  # ✅ added null/blank
    
    established_date = models.DateField(null=True, blank=True)  # ✅ added null/blank
    
    working_period = models.CharField(max_length=30, default='9:00 AM – 5:00 PM')  # ✅ sensible default
    
    large_option = models.CharField(max_length=30, default='Mixed')  # ✅ default
