...
class Representative(models.Model):
    ...
    representative_image = models.ImageField(upload_to='representatives/', blank=True, null=True)

    def __str__(self):
        return self.full_name

class Franchise(models.Model):
    franchise_id = models.CharField(max_length=10, unique=True, default=generate_franchise_id, editable=False)
...
class Branch(models.Model):
    branch_id = models.CharField(max_length=10, unique=True, default=generate_branch_id, editable=False)
